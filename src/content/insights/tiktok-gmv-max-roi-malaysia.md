---
title: Is TikTok Shop GMV Max ROI real for Malaysian sellers?
...
- [The issue: attributed sales are not the same as incremental sales](#the-issue-attributed-sales-are-not-the-same-as-incremental-sales)
- [GMV Max ROI, ROAS and profit are different numbers](#gmv-max-roi-roas-and-profit-are-different-numbers)
- [A measurement solution that works](#a-measurement-solution-that-works)
- [A worked Malaysian seller example](#a-worked-malaysian-seller-example)
- [What sellers and marketers often get wrong](#what-sellers-and-marketers-often-get-wrong)
- [Frequently asked questions](#frequently-asked-questions)
- [Measure the lift before scaling the spend](#measure-the-lift-before-scaling-the-spend)
...
TikTok defines Product GMV Max ROI as gross revenue from attributed paid and organic TikTok Shop orders divided by ad cost. Its [current attribution guidance](https://ads.tiktok.com/help/article/about-attribution-for-gmv-max) says all paid and organic orders for selected products are attributed to GMV Max while the campaign is active. It even gives the example of a purchase being attributed when the customer did not view or click an ad.

For a useful business decision, keep three figures separate:

1. **Platform ROI:** the total GMV Max-attributed gross revenue divided by ad spend.
2. **Incremental GMV multiple:** the additional net GMV caused by the campaign divided by ad spend.
3. **Incremental profit ROI:** the additional contribution profit after ad spend divided by ad spend.
...
TikTok describes Product GMV Max as an automation solution that uses available creative, including authorised affiliate content, and optimizes paid and organic delivery. Product GMV Max is [currently available in Malaysia](https://ads.tiktok.com/help/article/how-to-create-a-product-gmv-max-campaign-in-tiktok-ads-manager).

TikTok is open about the broad attribution. Its [Product GMV Max overview](https://ads.tiktok.com/help/article/about-product-gmv-max) says the dashboard includes orders from organic content and affiliate orders for advertised products. That makes sense for a system built to optimize total product GMV. But a seller usually needs an answer to a narrower question: **How many sales would disappear if I stopped spending this money?**
...
This is the concern sellers are raising publicly. In one [TikTok Shop seller discussion about GMV Max incrementality](https://www.reddit.com/r/TikTokshop/comments/1so3s91/re_gmv_max_ads_actually_driving_sales_or_just/), a seller reported that a product moved from roughly 16–17 units a day to 17–19, while the campaign displayed ROI around 7. In another [discussion about GMV Max taking credit for organic sales](https://www.reddit.com/r/TikTokshop/comments/1h2rhyk), sellers questioned how to evaluate paid performance when organic and affiliate sales appear in the same result.
...
TikTok's [Product GMV Max reporting guide](https://ads.tiktok.com/help/article/how-to-see-reporting-for-your-product-gmv-max-campaign) defines campaign ROI as:

`GMV Max ROI = attributed gross revenue ÷ ad cost`

TikTok's own [performance evaluation guidance](https://ads.tiktok.com/help/article/how-to-evaluate-the-performance-of-product-gmv-max) explains that Video Shopping Ads and Product Shopping Ads use ROAS based on ad GMV, whereas Product GMV Max uses ROI based on non-LIVE GMV and includes organic GMV. TikTok explicitly says those figures should not be compared directly because the attribution models differ.
...
- **WhatsApp:** [Message Wayne about a GMV Max ROI audit](https://wa.me/601123394398?text=Hi%20Wayne%2C%20I%27d%20like%20help%20measuring%20our%20true%20GMV%20Max%20ROI.).
- **Form:** [Open the guided Wayne Omni project brief form](/contact/#audit) and include the products, test dates and current ROI.
- **Email:** [Email your GMV Max measurement question](mailto:waynegtcfx@gmail.com?subject=TikTok%20Shop%20GMV%20Max%20ROI%20audit).
- **Discovery call:** [Schedule a 30-minute discovery call](https://calendly.com/waynegtcfx/30min) to review the attribution and test design.
